...
<li class='item active'><a href="/tratamentos/tratamento-estetico">Tratamento Estético</a></li>
@endsection

@section('breadcrumb-title','Tratamentos 100% Estéticos')

@section('breadcrumb-class','green')

@section('content')

    <div class="principal container">

        <h2 class="title">Tratamentos 100% Estéticos</h2>
