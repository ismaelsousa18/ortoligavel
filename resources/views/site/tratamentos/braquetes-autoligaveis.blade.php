...
<li class='item active'><a href="/tratamentos/braquetes-autoligaveis">Braquetes Autoligáveis</a></li>
@endsection

@section('breadcrumb-title','Braquetes Autoligáveis')

@section('breadcrumb-class','blue')

@section('content')

    <div class="principal container">

        <h2 class="title">Braquetes Autoligáveis</h2>
