...
<li class='item active'><a href="/tratamentos/tratamento-hibrido">Tratamento Híbrido</a></li>
@endsection

@section('breadcrumb-title','TOHi - Tratamento Ortodôntico Híbrido')

@section('breadcrumb-class','purple')

@section('content')

    <div class="principal container">

        <h2 class="title">TOHi - Tratamento Ortodôntico Híbrido</h2>
